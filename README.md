...
Creation of a Substrate parachain whose runtime compiles to WASM and that uses the a custom Bulletproof-specific runtime module that may be later ported over to the Polkadot network.
...
* [4] Paper - Efficient Protocols for Set Membershipt and Range Proofs, Camenisch, J. et al., https://infoscience.epfl.ch/record/128718/files/CCS08.pdf
